...
Name "Mythangs Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_Mythangs_${VERSION}.exe"
...
; Sections
Section "Mythangs" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\Mythangs"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\Mythangs\Plugin_Mythangs.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\Mythangs\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\Mythangs"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\Mythangs\Plugin_Mythangs.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\Mythangs\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_Mythangs"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_Mythangs\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Mythangs Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the Mythangs Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Mythangs Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_Mythangs\changelog.md"'
FunctionEnd
