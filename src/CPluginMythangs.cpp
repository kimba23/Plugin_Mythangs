...
#include <StdAfx.h>
#include <CPluginMythangs.h>

namespace MythangsPlugin
{
    CPluginMythangs* gPlugin = NULL;

    CPluginMythangs::CPluginMythangs()
    {
        gPlugin = this;
    }
    ...
    bool CPluginMythangs::Release( bool bForce )
    {
        bool bRet = true;
    ...
    bool CPluginMythangs::Init( SSystemGlobalEnvironment& env, SSystemInitParams& startupParams, IPluginBase* pPluginManager, const char* sPluginDirectory )
    {
    ...
    bool CPluginMythangs::RegisterTypes( int nFactoryType, bool bUnregister )
    {
    ...
    const char* CPluginMythangs::ListCVars() const
    {
        return "..."; // TODO: Enter CVARs/Commands here if you have some
    }

    const char* CPluginMythangs::GetStatus() const
    {
        return "OK";
    }
